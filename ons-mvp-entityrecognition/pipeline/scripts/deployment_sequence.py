...
if __name__=='__main__':
    ...
    predefined_training_path = f'{base_dir}/predefined_training/predefined.json'
    inequalities_training_path = f'{base_dir}/inequalities_training/inequalities.json'
    
    with open(predefined_training_path, "r") as f:
        predefined_deployment_dict = json.load(f)
    
    with open(inequalities_training_path, "r") as f:
        inequalities_deployment_dict = json.load(f)
        
    predefined_status = predefined_deployment_dict['deployment_status']
    predefined_production_variant = predefined_deployment_dict['production_variantt_id']
    
    inequalities_status = inequalities_deployment_dict['deployment_status']
    inequalities_production_variant = inequalities_deployment_dict['production_variantt_id']

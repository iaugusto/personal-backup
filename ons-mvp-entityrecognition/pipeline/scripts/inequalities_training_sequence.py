...
if __name__=='__main__':
    ...
    inequalities_training_dir = f'{base_dir}/inequalities_training'
    Path(inequalities_training_dir).mkdir(parents=True, exist_ok=True)
    ...
    #-------------------------------------------------------------------------
    #loading inequalities information
    inequalities_workload_path = f'{base_dir}/inequalities_workload/inequalities.json'
    
    with open(inequalities_workload_path, "r") as f:
        inequalities_workload_dict = json.load(f)
        
    inequalities_training_status = inequalities_workload_dict['training_status']
    inequalities_baseline_id = inequalities_workload_dict['baseline_id']
    ...
    inequalities_deployment_dict = {
        'deployment_status':inequalities_status,
        'production_variantt_id':inequalities_production_variant
    }
    
    inequalities_training_path = f'{inequalities_training_dir}/inequalities.json'
    
    with open(inequalities_training_path, "w") as f:
        f.write(json.dumps(inequalities_deployment_dict))
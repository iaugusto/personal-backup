...
'''
date_min = '2019-06-01 00:00:00'
date_max = '2019-06-01 04:10:00'
getdata = get_data.GetData(date_min, date_max)
df = getdata.get_prediction()
    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("Medição Indireta"),
                    html.H6("Medição de falhas em bombas"),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    ...
                    html.Img(id="logo", src=app.get_asset_url("tenbu-logo.png")),
                ],
            ),
        ],
    )
        ...
        children=[
            dcc.Tabs(
                ...
                children=[
                    dcc.Tab(
                        id="Specs-tab",
                        label="Configuração de Especificações",
                        value="tab1",
                    ...
                    dcc.Tab(
                        ...
                        label="Gráficos de acompanhamento",
                        value="tab2",
                        className="custom-tab",
                        selected_className="custom-tab--selected",
                    ),
...
def build_chart_panel():
    return html.Div(
        ...
        className="twelve columns",
        children=[
            generate_section_banner("Gráfico de medição em tempo real"),
            dcc.Graph(
    ...
    return (
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    id="graphs-container",
                    children=[build_chart_panel(), build_top_panel(stopped_interval)],
                ),
            ],
        ),
        stopped_interval,

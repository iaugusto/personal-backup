...
if __name__=='__main__':
    ...
    predefined_workload_dir = f'{base_dir}/predefined_workload'
    inequalities_workload_dir = f'{base_dir}/inequalities_workload'
    Path(predefined_workload_dir).mkdir(parents=True, exist_ok=True)
    Path(inequalities_workload_dir).mkdir(parents=True, exist_ok=True)
    ...
    #-------------------------------------------------------------------------
    #processing predefined workload
    predefined_training_status, predefined_baseline_id = process_workload(
        bucket=bucket,
        model='predefined'
        )
    
    predefined_workload_dict = {
        'training_status':predefined_training_status,
        'baseline_id':predefined_baseline_id
    }
    
    predefined_workload_path = f'{predefined_workload_dir}/predefined.json'
    
    with open(predefined_workload_path, "w") as f:
        f.write(json.dumps(predefined_workload_dict))
    
    #-------------------------------------------------------------------------
    #processing inequalities workload
    inequalities_training_status, inequalities_baseline_id = process_workload(
        bucket=bucket,
        model='inequalities'
        )
    
    inequalities_workload_dict = {
        'training_status':inequalities_training_status,
        'baseline_id':inequalities_baseline_id
    }
    
    inequalities_workload_path = f'{inequalities_workload_dir}/inequalities.json'
    
    with open(inequalities_workload_path, "w") as f:
        f.write(json.dumps(inequalities_workload_dict))